			...
			<!-- /header -->
  						<div class="row">
							...
							?>
  								...
  								<h3 class="page-header animated bounceInRight show-info" ><i class="fa fa-spin fa-spinner"></i><?php echo $filename; ?> <i class="fa fa-group animated bounceInDown show-info"></i> </h3>
